...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        int id=view.getId();
        String mWhiteColor="#FFFFFF";
        switch (id){
            case R.id.ll3:
                view1.setBackgroundColor(Color.parseColor("#FF35C611"));
                view2.setBackgroundColor(Color.parseColor(mWhiteColor));
                view3.setBackgroundColor(Color.parseColor(mWhiteColor));
                break;
            case R.id.ll4:
                view1.setBackgroundColor(Color.parseColor(mWhiteColor));
